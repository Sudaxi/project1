...
@interface DXKVOViewController ()
@property (strong, nonatomic)  UITextField *txtField;
@end

@implementation DXKVOViewController
...
- (void)backAction:(id)sender {
    //改变值
    [self willChangeValueForKey:@"kvoText"];
    self.kvoText = self.txtField.text;
    [self didChangeValueForKey:@"kvoText"];
